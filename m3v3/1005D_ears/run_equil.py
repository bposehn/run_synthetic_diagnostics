...
SCALARS_TABLE_PATH = os.path.join(INPUT_DATA_PATH, 'M3_1005D_w_ears_0.10Wb-n2e19-lampeak-eps0.6-t300-r0.csv')
...
prev_file = None# 'out/m3v3_0.002840.hdf5'
all_run_params = []
# for i_row, row in scalars_df.iterrows():
for i_row in range(0, len(scalars_df)):
